...
#define DEF_TWO_PHASE_FREQUENCY			(1026000)
#define DBS_INPUT_EVENT_MIN_FREQ		(702000)
#define DEF_FREQUENCY_OPTIMAL			(1350000)
#define DEF_FREQ_DOWN_STEP				(384000)
...
#define DEF_INPUT_BOOST_DURATION		(0)
#define CPU0					(0)
